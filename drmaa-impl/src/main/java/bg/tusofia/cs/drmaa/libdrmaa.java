...
public class libdrmaa {
    ...
    public static int drmaa_allocate_job_template(
            Pointer<Pointer<libdrmaa.drmaa_job_template_s>> jt,
            Pointer<Byte> error_diagnosis, @Ptr long error_diag_len) {
    ...
    public static int drmaa_delete_job_template(
            Pointer<libdrmaa.drmaa_job_template_s> jt,
            Pointer<Byte> error_diagnosis, @Ptr long error_diag_len) {
    ...
    public static int drmaa_set_attribute(
            Pointer<libdrmaa.drmaa_job_template_s> jt, Pointer<Byte> name,
    ...
    public static int drmaa_get_vector_attribute(
            Pointer<libdrmaa.drmaa_job_template_s> jt, Pointer<Byte> name,
            Pointer<Pointer<libdrmaa.drmaa_attr_values_s>> values,
            Pointer<Byte> error_diagnosis, @Ptr long error_diag_len) {
    ...
    public static int drmaa_get_attribute_names(
            Pointer<Pointer<libdrmaa.drmaa_attr_names_s>> values,
            Pointer<Byte> error_diagnosis, @Ptr long error_diag_len) {
    ...
    public static int drmaa_get_next_attr_name(
            Pointer<libdrmaa.drmaa_attr_names_s> values, Pointer<Byte> value,
            @Ptr long value_len) {
    ...
    public static int drmaa_get_next_attr_value(
            Pointer<libdrmaa.drmaa_attr_values_s> values,
            Pointer<Byte> value, @Ptr long value_len) {
    ...
    public static int drmaa_get_next_job_id(
            Pointer<libdrmaa.drmaa_job_ids_s> values, Pointer<Byte> value,
            @Ptr long value_len) {
    ...
    public static int drmaa_get_num_attr_names(
            Pointer<libdrmaa.drmaa_attr_names_s> values, Pointer<SizeT> size) {
    ...
    public static int drmaa_get_num_attr_values(
            Pointer<libdrmaa.drmaa_attr_values_s> values, Pointer<SizeT> size) {
    ...
    public static int drmaa_get_num_job_ids(
            Pointer<libdrmaa.drmaa_job_ids_s> values, Pointer<SizeT> size) {
    ...
    public static void drmaa_release_attr_names(
            Pointer<libdrmaa.drmaa_attr_names_s> values) {
    ...
    public static void drmaa_release_job_ids(
            Pointer<libdrmaa.drmaa_job_ids_s> values) {
    ...
    public static int drmaa_run_bulk_jobs(
            Pointer<Pointer<libdrmaa.drmaa_job_ids_s>> jobids,
            Pointer<libdrmaa.drmaa_job_template_s> jt, int start, int end,
    ...
    public static int drmaa_wait(Pointer<Byte> job_id,
                                 ...
                                 Pointer<Pointer<libdrmaa.drmaa_attr_values_s>> rusage,
                                 Pointer<Byte> error_diagnosis, @Ptr long error_diag_len) {
